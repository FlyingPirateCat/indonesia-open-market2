<nav class="navbar navbar-expand navbar-light bg-black topbar mb-4 static-top shadow">
    ...
    <div class="navbar-nav ml-4 gap-4">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            <a class="nav-link dropdown-toggle mr-2" href="#" id="gtranslate" role="button"
                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <i class="fas fa-globe fa-fw"></i>
            </a>
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                aria-labelledby="gtranslate">
                <div class="pl-2" id="gt-mordadam-43217984"></div>
            </div>
        </li>
