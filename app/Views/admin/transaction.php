                                    ...
                                    <tbody class="table-body">
                                        ...
                                        <?php foreach ($ordermodel as $key => $model): ?>
                                            <tr class="cell-1">
                                                ...
                                                <?php $user = $users->select('shopname'); ?>
                                                <?php $user->where(['id' => $model['id_seller']]); ?>
                                                <td><?= $user->first()->shopname; ?></td>
                                                <?php
                                                $status = $model['status'];
                                                $badge = 'badge-info';
